...
<%@include file="header.jsp" %>
		...
		<%
			...
			Object obj = request.getAttribute("userPersonList");
			if(null!=obj) {
				userPersonList = (List<Person>) obj;
			}
		%>
		<%
		...
		%>
		<h2>Total </h2>
		Total list of persons is : <%= userPersonList.size() %>
		<%
		...
		<%				
			for(Person person : userPersonList)
			{
				...
				"<a href='Edit?id=" + person.getId() + "'>E</a> | " +
